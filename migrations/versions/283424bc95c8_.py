...
Revision ID: 283424bc95c8
Revises: 
Create Date: 2019-05-30 21:47:51.246421
...
def upgrade():
    ...
    sa.Column('path', sa.String(length=4), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_post_path'), 'post', ['path'], unique=True)
